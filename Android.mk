...
include $(CLEAR_VARS)
LOCAL_MODULE := HotwordEnrollmentOKGoogleTL3210
LOCAL_MODULE_OWNER := lenovo
LOCAL_SRC_FILES := proprietary/priv-app/HotwordEnrollmentOKGoogleTL3210/HotwordEnrollmentOKGoogleTL3210.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := HotwordEnrollmentXGoogleTL3210
LOCAL_MODULE_OWNER := lenovo
LOCAL_SRC_FILES := proprietary/priv-app/HotwordEnrollmentXGoogleTL3210/HotwordEnrollmentXGoogleTL3210.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
